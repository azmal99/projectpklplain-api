...
class DashboardCSMController extends Controller
{
    ...
    public function listtransactions()
    {
        ...
        $transactions = DB::table('pawoon2.transactions')
            ->select('pawoon2.transactions.t_id as id', 'pawoon2.transactions.uuid', 'pawoon2.transactions.receipt_code', 'pawoon2.transactions.customer_name', 'pawoon2.transactions.final_amount')
            //->offset($start)
            ->limit(10000)
            ->get();
